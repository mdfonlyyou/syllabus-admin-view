...
<script>
  ...
  import {getLessonById} from '../../assets/lesson';
  import {editLessonById} from '../../assets/lesson';
  export default {
    data() {
      return {
        data1: {
    ...
    methods: {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            editLessonById(_this.$route.query.id,para).then(response => {
      ...
      getLessonInfos(){
        ...
        getLessonById(this.$route.query.id).then(response => {
