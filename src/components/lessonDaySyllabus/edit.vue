<template>
  <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="120px" class="demo-ruleForm"
           style="margin:30px;width:80%;min-width:600px;" v-loading="editloading">
    ...
    <el-dialog
      ...
      :before-close="handleClose">
        <span>
          <new-syllabus :is_type_show="is_type_show" :is_syllabus_show="is_syllabus_show" @getSyllabus="getSyllabus1"></new-syllabus>
...
<script>
  import {editLessonDaySyllabusInfos} from '../../assets/lesson'
  import NewSyllabus  from '../../components/lessonDaySyllabus/newSyllabus.vue'
  import {getLessonDaySyllabusInfos} from '../../assets/lesson'
  export default {
    data() {
    ...
    methods: {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            editLessonDaySyllabusInfos(_this.$route.query.lid,_this.$route.query.did,_this.$route.query.sid,para).then(response => {
      ...
      getEditInfos(){
        ...
        getLessonDaySyllabusInfos(this.$route.query.lid,this.$route.query.did,this.$route.query.sid).then(response => {
              this.ruleForm2.value2=response.data.hour+':'+response.data.minute;
              this.ruleForm2.syllabus_id=response.data.fk_syllabus_id;
